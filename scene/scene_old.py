...
from scene.dataset_readers import readColmapSceneInfo, fetchPly, readSlamSceneInfo
    ...
    def __init__(
        ...
        for resolution_scale in resolution_scales:
            ...
            self.train_cameras[resolution_scale] = cameraList_from_camInfos(
                scene_info.train_cameras, resolution_scale, downscale=args.resolution
            )
            logger.debug(
            ...
            self.test_cameras[resolution_scale] = cameraList_from_camInfos(
                scene_info.test_cameras, resolution_scale, downscale=args.resolution
            )
            logger.debug(
