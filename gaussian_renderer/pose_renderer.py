...
import torch
import typing
from diff_gaussian_rasterization_w_pose import (
...
def render(
    ...
    *,
    ...
    # Finding projmatrix_raw
    projmatrix_raw = (viewpoint_camera.projection_matrix.T@viewpoint_camera.world_view_transform.T).T
